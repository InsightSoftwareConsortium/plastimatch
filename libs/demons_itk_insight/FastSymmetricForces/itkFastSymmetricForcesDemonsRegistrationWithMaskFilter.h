/*=========================================================================
  ...
  Module:    itkFastSymmetricForcesDemonsRegistrationWithMaskFilter.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
#ifndef __itkFastSymmetricForcesDemonsRegistrationWithMaskFilter_h
#define __itkFastSymmetricForcesDemonsRegistrationWithMaskFilter_h
...
class ITK_EXPORT FastSymmetricForcesDemonsRegistrationWithMaskFilter :
...
private:
  FastSymmetricForcesDemonsRegistrationWithMaskFilter(const Self&); //purposely not implemented
...
#include "itkFastSymmetricForcesDemonsRegistrationWithMaskFilter.txx"
#endif
